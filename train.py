...
def train(training_scenes, train_objects, rank, args, shared_model, counter, lock, config, optimizer=None, use_gpu=False):
    torch.manual_seed(args.seed + rank)

    env = AI2ThorDumpEnv(config, training_scenes, train_objects)
